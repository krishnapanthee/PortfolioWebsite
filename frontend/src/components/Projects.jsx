...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "LMS Platform",
      description:
        "A learning management system for student-teacher interaction, course enrollment, and progress tracking.",
      github: "https://github.com/krishnapanthee",
      demo: "https://lms-learning-management-system.vercel.app/",
    },
    {
      image: bloggingImage,
      title: "Blogging Platform",
      description:
        "A clean blogging platform for creating, editing, and publishing engaging articles with modern UI.",
      github: "https://github.com/krishnapanthee",
      demo: "https://bloggingwebsite.vercel.app/",
    },
  ];
  ...
  return (
    <div id="projects" className={`py-16 sm:py-20 md:py-24 px-6 sm:px-8 ${
      ...
      {isTouch ? (
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory -mx-4 px-1 sm:mx-0">
          {projects.map((project, index) => (
            <div key={project.title} className="flex-shrink-0 w-[90vw] max-w-[350px] min-w-[260px] snap-center">
...
const ProjectItem = ({ image, title, description, github, demo, theme }) => {
  return (
    <div className={`${
      ...
      {/* Title */}
      <h3 className={`text-xl sm:text-2xl font-bold mt-4 sm:mt-5 text-center ${
        theme === 'dark' ? 'text-white' : 'text-gray-900'
      } transition-colors duration-300`}>
        {title}
      </h3>
