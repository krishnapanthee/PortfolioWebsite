...
const Education = ({ data }) => {
  ...
  return (
    <section id="education" ref={sectionRef} className="py-10 sm:py-12">
      <div className={`${isVisible ? "animate-fadeIn" : "opacity-0"}`}>
        <p className="font-mono text-sm mb-4 text-[#10b981]">education</p>
          ...
          {educationList.map((edu, index) => (
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <p className={`text-sm ${theme === "dark" ? "text-[#a3a3a3]" : "text-[#525252]"}`}>
                  {edu.institution}
                </p>
              </div>
            </div>
